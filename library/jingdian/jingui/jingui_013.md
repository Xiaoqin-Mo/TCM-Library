...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['消渴', '淋病', '小便不利', '水逆']
  zhengzhuang: []
  fangming: []
  yaoming: ['肾气丸', '五苓散', '文蛤散', '栝蒌瞿麦丸', '蒲灰散', '滑石白鱼散', '茯苓戎盐汤', '白虎加人参汤', '猪苓汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['消渴', '饮一斗小便一斗', '淋之为病小便如粟状', '小便不利', '水逆', '胃热']
weight: 10
tags: ['经典医籍', '金匮要略', '消渴']
---
...
**【古注】**
尤在泾《心典》：消渴分厥阴消渴与肾气丸证；淋病小便如粟、小腹弦急；小便不利分湿热与水气两型。

**【白话提要】**
本篇论消渴、小便不利、淋病。消渴有厥阴气上冲心及男子饮一溲一（肾气丸）两型；淋病以小便如粟状、小腹弦急为主；小便不利分水气（五苓散、栝蒌瞿麦丸）、湿热（蒲灰散、猪苓汤）等型。
