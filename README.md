...
**当前收录（2026-09）**：全库 **1630 条** —— 五大经典全文（《素问》81 / 《灵枢》81 / 《伤寒论》657+序 2 / 《金匮要略》25 / 《难经》81）+ 中国药典（2025 年版）一部药材和饮片 637 条 + 药典外常用品种 64 条。详见 [MILESTONES.md](MILESTONES.md)。
...
- **结构化检索**：11 个中医检索维度（证型/治法/病症/症状/方名/药名/腧穴/经络/四气/五味/归经）+ 开放主题词；跨字段 AND、同字段 OR，命中特异性优先排序
...
| `zhenjiu` | 针灸推拿 | 经络 / 腧穴 / 刺法灸法 / 推拿 / 针灸治疗学 |
