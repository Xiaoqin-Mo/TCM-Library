...
- [x] B1 经穴 361（新写 360，含既有足三里；PR #16）
- [x] B2 针灸大成精选 24 篇（PR #17）
- [x] B3 诊断学要点 52（PR #18）
- [x] B4 内科 47（PR #19）
- [x] B5 温病学 52（PR #20）
- [x] B6 医案 50（PR #21）
...
| B5 温病学 | #20 | 52 | 已合 |
| B6 医案 | #21 | 50 | 已合 |
| **合计** | — | **585** | dev 1630 → **2215** |

> 完成：validate 0 错 0 警（2215）、回归 18/18、契约 0 错；新增覆盖 zhenjiu /
> zhenduan / linchuang / jingdian / yishi 五个顶层分类（全库 10 类均有收录）。
> 已知消歧命名：重名穴位/病证按经络或领域后缀（_gb/_gv/_te/_sp/_st/_bl/_li/_neike 等）。
