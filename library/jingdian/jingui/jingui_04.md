...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ["疟病", "疟母", "瘅疟", "温疟", "牡疟"]
  zhengzhuang: ["休作有时", "身无寒但热", "骨节疼烦", "时呕"]
  fangming: ["鳖甲煎丸", "白虎加桂枝汤", "蜀漆散", "牡蛎汤", "柴胡去半夏加栝蒌汤", "柴胡姜桂汤"]
  yaoming: []
  xuewei: []
  jingluo: []
  siqi: []
...
**【白话提要】**
本篇论疟病脉证并治。疟脉自弦，弦数多热、弦迟多寒，弦小紧可下、弦迟可温、弦紧可发汗针灸、浮大可吐。病疟月一日发当十五日愈，不差则结为癥瘕名曰疟母，急治之宜鳖甲煎丸。阴气孤绝阳气独发、但热少气烦冤手足热欲呕为瘅疟；身无寒但热、骨节疼烦时呕为温疟，用白虎加桂枝汤；疟多寒名牡疟，用蜀漆散。末附《外台》牡蛎汤治牡疟、柴胡去半夏加栝蒌汤治发渴及劳疟、柴胡姜桂汤治寒多微热或但寒不热。
