...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['肝着', '脾约', '肾着', '积', '聚', '馨气']
  zhengzhuang: []
  fangming: []
  yaoming: ['旋复花汤', '麻子仁丸', '甘姜苓术汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['五脏中风中寒', '肝着', '脾约', '肾着', '积者藏病', '聚者府病', '三焦竭部']
weight: 10
tags: ['经典医籍', '金匮要略', '脏腑积聚']
---
...
**【古注】**
尤在泾《心典》：此篇分论五脏中风中寒及真脏脉，并辨积、聚、馨气之异，附肝着、脾约、肾着诸方。

**【白话提要】**
本篇分论五脏中风中寒诸证及真脏死脉，并辨积（藏病不移）、聚（府病发作有时）、馨气（按之则愈）之别。出肝着（旋复花汤）、脾约（麻子仁丸）、肾着（甘姜苓术汤）三方。
