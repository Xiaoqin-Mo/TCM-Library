...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['谷疸', '酒疸', '女劳疸', '黑疸']
  zhengzhuang: []
  fangming: []
  yaoming: ['茵陈蒿汤', '硝石矾石散', '栀子大黄汤', '桂枝加黄芪汤', '猪膏发煎', '茵陈五苓散', '大黄硝石汤', '小半夏汤', '小柴胡汤', '小建中汤', '麻黄醇酒汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['黄疸', '脾色必黄瘀热以行', '谷疸', '酒疸', '女劳疸', '诸黄但利小便']
weight: 10
tags: ['经典医籍', '金匮要略', '黄疸']
---
...
**【古注】**
尤在泾《心典》：黄疸为脾湿瘀热发黄，分谷疸、酒疸、女劳疸；诸黄但利小便为大法，茵陈蒿汤为正治。

**【白话提要】**
本篇论黄疸病，分谷疸（食即头眩）、酒疸（心中懊憹）、女劳疸（额上黑）三型，久延为黑疸。治则诸黄但利小便，脉浮当汗解；主方茵陈蒿汤、栀子大黄汤、硝石矾石散、大黄硝石汤等。
