...
conditions:
  ...
  fangming: []
  yaoming: []
  xuewei: ["三里", "阴陵泉", "巨虚上廉", "巨虚下廉"]
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ["四时气", "四时刺法", "温疟", "徒水", "邪在六腑"]
weight: 10
...
**【白话提要】**
本篇论四时之气各有所在，灸刺当随气所在取穴。春取经血脉分肉、夏取盛经孙络、秋取经俞邪在腑取合、冬取井荥深留。次分论温疟汗不出、风水肤胀、飧泄、转筋、徒水、着痹、肠中不便、疠风等证刺法；并论邪在大肠、小肠、胆、胃脘、三焦诸腑病候与取穴；末以色脉气口人迎辨病之存亡进退。
