...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['刚痉', '柔痉', '湿痹', '风湿', '中暍', '中热']
  zhengzhuang: []
  fangming: []
  yaoming: ['栝蒌桂枝汤', '葛根汤', '大承气汤', '麻黄加术汤', '麻黄杏仁薏苡甘草汤', '防己黄芪汤', '桂枝附子汤', '白术附子汤', '甘草附子汤', '白虎加人参汤', '一物瓜蒂汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['刚痉', '柔痉', '湿痹', '风湿', '中暍', '汗法', '利小便']
weight: 10
tags: ['经典医籍', '金匮要略', '痉湿暍']
---
...
**【古注】**
尤在泾《心典》：痉病以强急反张为主，湿痹以关节疼烦为主，暍即中暑，三病皆太阳经兼证。

**【白话提要】**
本篇论痉、湿、暍三病。痉病分刚柔，主强急口噤、背反张；湿痹以身疼发热、小便不利为主；风湿当微发其汗；中暍属夏月伤暑，分热胜与水停两型，各出主方。
