...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['疟母', '瘅疟', '温疟', '牡疟']
  zhengzhuang: []
  fangming: []
  yaoming: ['鳖甲煎丸', '白虎加桂枝汤', '蜀漆散', '牡蛎汤', '柴胡去半夏加栝蒌汤', '柴胡姜桂汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['疟脉自弦', '疟母', '瘅疟', '温疟', '牡疟', '寒热']
weight: 10
tags: ['经典医籍', '金匮要略', '疟病']
---
...
**【古注】**
尤在泾《心典》：疟脉自弦，弦数多热，弦迟多寒；久疟结为癥瘕名曰疟母，宜鳖甲煎丸。

**【白话提要】**
本篇论疟病脉证治法。疟脉自弦，分瘅疟（但热不寒）、温疟（寒少热多）、牡疟（多寒）三型；久疟不愈结为疟母，宜鳖甲煎丸缓消；附《外台》三方备参。
