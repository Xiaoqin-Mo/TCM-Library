...
conditions:
  ...
  zhifa: []
  bingzheng: ["腹满", "寒疝", "宿食"]
  zhengzhuang: ["腹满", "绕脐痛", "肠鸣切痛", "呕吐", "按之痛"]
  fangming: ["厚朴七物汤", "附子粳米汤", "厚朴三物汤", "大柴胡汤", "大承气汤", "大建中汤", "大黄附子汤", "赤丸", "大乌头煎", "当归生姜羊肉汤", "乌头桂枝汤", "瓜蒂散"]
  yaoming: []
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ["腹满虚实", "寒疝", "宿食", "大建中汤", "大乌头煎", "当归生姜羊肉汤"]
weight: 10
tags: ["经典医籍", "金匮要略", "腹满寒疝"]
---
...
**【白话提要】**
本篇论腹满、寒疝、宿食。腹满按之不痛为虚、痛者为实可下，舌黄未下者下之黄自去；腹满时减复如故为寒当与温药。腹满发热十日脉浮数饮食故用厚朴七物汤；腹中寒气雷鸣切痛胸胁逆满呕吐用附子粳米汤；痛而闭用厚朴三物汤；按之心下满痛为实用大柴胡汤；心胸中大寒痛、上冲皮起有头足、不可触近用大建中汤；胁下偏痛发热脉紧弦为寒、当温下用大黄附子汤。寒疝绕脐痛、发则白汗出手足厥冷用大乌头煎；腹中痛胁痛里急用当归生姜羊肉汤。宿食在上脘当吐用瓜蒂散，在中、下用大承气汤。
