...
conditions:
  zhengxing: ["肾阳不足"]
  zhifa: ["补肾助阳"]
  bingzheng: ["腰痛", "水肿", "阳痿", "消渴"]
  zhengzhuang: ["腰痛脚软", "小便不利或反多", "畏寒肢冷", "下半身常有冷感", "舌淡胖"]
  fangming: ["肾气丸"]
  yaoming: ["干地黄", "薯蓣", "山茱萸", "泽泻", "茯苓", "牡丹皮", "桂枝", "附子"]
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
...
**【白话提要】**
肾气丸（金匮肾气丸）为补肾助阳之祖方，主治肾阳不足之腰痛脚软、小便不利或反多、畏寒肢冷。方中重用干地黄滋阴补肾，薯蓣、山茱萸补肝脾，少量桂枝、附子温肾助阳（阴中求阳），泽泻、茯苓、丹皮利水泻浊。
