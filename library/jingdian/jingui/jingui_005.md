...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['中风', '历节', '痹', '风痱', '脚气']
  zhengzhuang: []
  fangming: []
  yaoming: ['侯氏黑散', '风引汤', '防己地黄汤', '头风摩散', '桂枝芍药知母汤', '乌头汤', '矾石汤', '续命汤', '三黄汤', '术附汤', '八味丸', '越婢加术汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['半身不遂', '喎僻不遂', '邪在于络', '历节疼痛', '脚气冲心']
weight: 10
tags: ['经典医籍', '金匮要略', '中风历节']
---
...
**【古注】**
尤在泾《心典》：中风有在络在经入腑入脏之深浅，历节因汗出入水、饮酒当风致肢节疼痛如掣。

**【白话提要】**
本篇论中风与历节。中风分中络（肌肤不仁）、中经（重不胜）、入腑（不识人）、入脏（舌难言）深浅；历节以肢节疼痛不可屈伸为主，因汗出入水、饮酒当风所致，主以桂枝芍药知母汤、乌头汤；附方多首备参。
