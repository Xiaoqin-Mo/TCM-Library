...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['呕吐', '哕', '胃反', '下利', '热利']
  zhengzhuang: []
  fangming: []
  yaoming: ['茱萸汤', '半夏泻心汤', '黄芩加半夏生姜汤', '小半夏汤', '猪苓散', '四逆汤', '小柴胡汤', '大半夏汤', '大黄甘草汤', '茯苓泽泻汤', '文蛤汤', '半夏干姜散', '生姜半夏汤', '橘皮汤', '橘皮竹茹汤', '大承气汤', '小承气汤', '桃花汤', '白头翁汤', '栀子豉汤', '通脉四逆汤', '紫参汤', '诃梨勒散']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['呕吐哕', '胃反朝食暮吐', '诸呕吐谷不得下', '下利清谷', '热利下重', '下利便脓血']
weight: 10
tags: ['经典医籍', '金匮要略', '呕吐下利']
---
...
**【古注】**
尤在泾《心典》：呕吐哕辨虚实寒热，下利分寒热与虚实；胃反为脾伤不磨，热利下重主白头翁汤。

**【白话提要】**
本篇论呕吐、哕、下利。呕吐分寒热虚实，胃反（朝食暮吐）主大半夏汤，呕而发热主小柴胡汤；下利分虚寒（四逆汤、桃花汤）与实热（大承气汤、白头翁汤），热利下重主白头翁汤；附方多首。
