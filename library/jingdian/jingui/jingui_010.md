...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['腹满', '寒疝', '宿食', '胃反']
  zhengzhuang: []
  fangming: []
  yaoming: ['厚朴七物汤', '附子粳米汤', '厚朴三物汤', '大柴胡汤', '大承气汤', '大建中汤', '大黄附子汤', '赤丸', '大乌头煎', '当归生姜羊肉汤', '乌头桂枝汤', '瓜蒂散']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['腹满', '按之痛为实', '绕脐痛', '寒疝', '宿食不消', '当吐当下']
weight: 10
tags: ['经典医籍', '金匮要略', '腹满寒疝']
---
...
**【古注】**
尤在泾《心典》：腹满按之不痛为虚、痛者为实；寒疝绕脐痛、手足厥冷，主大乌头煎；宿食在上当吐、在中当下。

**【白话提要】**
本篇论腹满、寒疝、宿食。腹满分虚实，实者可下（大承气、大柴胡），寒者宜温（附子粳米、大建中）；寒疝以绕脐痛、手足厥冷为主，主大乌头煎或当归生姜羊肉汤；宿食在上脘当吐（瓜蒂散），在中下当下。
