...
- [x] PR-A 计划文档 — 随 PR #26 合入 dev（未单独立 PR）
- [x] PR-B 经方条目 — **实际收录 39 首**（计划 27 首 + 补入 12 首：竹叶石膏汤、麻杏石甘汤、生姜泻心汤、抵挡汤、四逆散、温经汤、当归芍药散、桂枝茯苓丸、肾气丸、十枣汤、大建中汤等），PR #26 合入 dev（2254 条全绿）。计划清单中 4 首（桂枝加葛根汤、大陷胸汤、麻黄附子细辛汤、苓桂术甘汤）未收录，待后续补充
- [ ] PR-C 上经 50 味 — 待启动（素材勘察后进行）
- [ ] PR-D 中经 50 味 — 待启动
- [ ] PR-E 下经 50 味 — 待启动
