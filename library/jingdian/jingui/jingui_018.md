...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['肠痈', '浸淫疮', '金疮', '疮痈']
  zhengzhuang: []
  fangming: []
  yaoming: ['薏苡附子败酱散', '大黄牡丹汤', '王不留行散', '排脓散', '排脓汤', '黄连粉']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['疮痈', '肠痈', '其身甲错', '少腹肿痞', '排脓', '金疮']
weight: 10
tags: ['经典医籍', '金匮要略', '疮痈']
---
...
**【古注】**
尤在泾《心典》：肠痈分脓未成与脓已成，未成可下、成不可下；薏苡附子败酱散排脓消肿，大黄牡丹汤泻热逐瘀。

**【白话提要】**
本篇论疮痈、肠痈、浸淫疮、金疮。肠痈以身甲错、腹皮急按之濡为辨证，脓未成（脉迟紧）可下，脓已成（脉洪数）不可下；主薏苡附子败酱散排脓、大黄牡丹汤泻热逐瘀；金疮主王不留行散。
