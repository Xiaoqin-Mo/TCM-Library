...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ['肺痿', '肺痈', '肺胀', '咳嗽上气']
  zhengzhuang: []
  fangming: []
  yaoming: ['甘草干姜汤', '射干麻黄汤', '皂荚丸', '厚朴麻黄汤', '泽漆汤', '麦门冬汤', '葶苈大枣泻肺汤', '桔梗汤', '越婢加半夏汤', '小青龙加石膏汤', '桔梗白散', '苇茎汤']
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ['肺痿', '肺痈', '肺胀', '咳而上气', '喉中水鸡声', '吐脓如米粥', '上焦热']
weight: 10
tags: ['经典医籍', '金匮要略', '肺痿肺痈']
---
...
**【古注】**
尤在泾《心典》：肺痿脉数虚，肺痈脉数实；咳而上气有射干麻黄、厚朴麻黄、泽漆汤等分治，肺痈主葶苈大枣泻肺汤。

**【白话提要】**
本篇论肺痿、肺痈、咳嗽上气。肺痿因重亡津液、多涎沫不咳；肺痈咳唾脓血、脉数实；咳嗽上气分寒饮（射干麻黄汤）、痰浊（皂荚丸）、水饮（泽漆汤）等型；附《外台》《千金》苇茎汤等。
