...
conditions:
  zhengxing: []
  zhifa: []
  bingzheng: ["呕吐", "哕", "胃反", "下利"]
  zhengzhuang: ["朝食暮吐", "呕而胸满", "心下痞", "下利清谷", "便脓血", "热利下重"]
  fangming: ["吴茱萸汤", "半夏泻心汤", "黄芩加半夏生姜汤", "小半夏汤", "猪苓散", "四逆汤", "小柴胡汤", "大半夏汤", "大黄甘草汤", "茯苓泽泻汤", "文蛤汤", "半夏干姜散", "生姜半夏汤", "橘皮汤", "橘皮竹茹汤", "大承气汤", "小承气汤", "桃花汤", "白头翁汤", "栀子豉汤", "通脉四逆汤"]
  yaoming: []
  xuewei: []
  jingluo: []
  siqi: []
  wuwei: []
  guijing: []
  keywords: ["呕吐哕", "胃反", "下利", "白头翁汤", "大半夏汤", "通脉四逆汤"]
weight: 10
tags: ["经典医籍", "金匮要略", "呕吐下利"]
---
...
**【白话提要】**
本篇论呕吐、哕、胃反与下利。呕家有痈脓不可治呕，脓尽自愈；先呕却渴为欲解，先渴却呕为水停心下属饮家；趺阳脉浮涩、脾不磨，朝食暮吐暮食朝吐宿谷不化名胃反。呕而胸满、干呕吐涎沫头痛用吴茱萸汤；呕而肠鸣心下痞用半夏泻心汤；胃反呕吐用大半夏汤；食已即吐用大黄甘草汤；呕而发热用小柴胡汤；哕逆用橘皮竹茹汤。下利辨脉证死生：脉沉弦下重、微弱数为欲自止；热利下重用白头翁汤，便脓血用桃花汤，下利清谷里寒外热汗出而厥用通脉四逆汤，谵语有燥屎用小承气汤，实积内停用大承气汤。
